...
Route::patch('/attendance/{id}/registration-cancel', [AttendanceController::class, 'cancelRegistration'])->name('attendance.cancelRegistration');
...
Route::patch('/attendance/{id}/lucky-draw-cancel', [AttendanceController::class, 'cancelLuckyDraw'])->name('attendance.cancelLuckyDraw');
